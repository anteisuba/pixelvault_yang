...
| **Spec 3** | [Cards 模块目录化 + Recipe 三套归位](./2026-05-28-spec-3-cards-module.md)  | 修正 Spec 1 的 recipe 归属错判：recipe → Prompts、card-recipe → Cards、recipe-compiler → L0；Cards 模块目录化；ESLint 扩展 | ✅ 已定稿 | 中（~38 文件 + 1 重命名）      |
