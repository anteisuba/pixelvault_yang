...
const falBodyCases: FalBodyCase[] = [
  ...
  {
    label: 'Vidu Q3 Pro T2V',
    modelId: AI_MODELS.VIDU_Q3_PRO,
    expectedEndpoint: 'fal-ai/vidu/q3/text-to-video',
    expectedMode: 'text-to-video',
    expectedBody: {
      prompt: PROMPT,
      duration: 5,
  ...
  {
    label: 'Vidu Q3 Pro I2V',
    modelId: AI_MODELS.VIDU_Q3_PRO,
    referenceImage: REF,
    expectedEndpoint: 'fal-ai/vidu/q3/image-to-video',
    expectedMode: 'image-to-video',
    expectedBody: {
      prompt: PROMPT,
      image_url: REF,
