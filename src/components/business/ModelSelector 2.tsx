...
interface ModelSelectorProps {
  ...
  /** Set of API key providers the user has active keys for */
  activeKeyProviders?: Set<string>
}
 ...
 */
export function ModelSelector({ value, onChange, activeKeyProviders }: ModelSelectorProps) {
      ...
      <Select value={value} onValueChange={onChange}>
        ...
        <SelectContent>
          {availableModels.map((model) => {
            ...
            const hasOwnKey = activeKeyProviders != null
              ? activeKeyProviders.has(model.id)
              : false
            // Disable the model when keys are loaded and no active key for this model
            const isDisabled = activeKeyProviders != null && !hasOwnKey
