...
2. [产品范围与第一版边界](../product/product-scope.md)
3. [技术架构与地基设计](../architecture/foundation-architecture.md)
4. [Prompt 数据与推荐系统设计](../plans/product/prompt-data-and-recommendation.md)
5. [开发阶段追踪](../progress/phases.md)
6. [需要拍板的关键决定](../product/key-product-decisions.md)
7. [按角色阅读路径](./reading-paths.md)
