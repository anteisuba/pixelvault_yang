# 05 · 视频剧本（Video Script）

> 范畴：AI 辅助视频创作全链路 — 主题输入 → 结构化剧本 → 分镜图 → 视频 clip → 拼接导出。
>
> 本目录是 `01-UI / 02-功能 / 03-功能测试 / 04-UI测试` 四卷之外新增的能力域，文档结构与之对齐。
...
| `03-工作包细分-Phase1+.md`   | Phase 1-4 工作包（Phase 0 验收后再写）   |
| `02-现状映射.md`             | 基于当前代码的能力映射（Phase 0 末刷新） |
