...
| #       | 改什么                                                                                                           | 依赖 | 状态    |
| ------- | ---------------------------------------------------------------------------------------------------------------- | ---- | ------- |
| —       | 讨论：怎么做出用户想要的结果（问 / 做 · 分析 · 界面 · 各页分工 · 导演流程）→ ② 思维导图                          | —    | 进行中  |
...
| #   | 改什么                                                                                                                 | 依赖    | 状态    |
| --- | ---------------------------------------------------------------------------------------------------------------------- | ------- | ------- |
| 35  | 卡片总线 spec（referenceSlots）+ v3 迁移（handle · summary · relations · loreEntries · persona.examples · extensions） | 27 ✓    | 待 spec |
