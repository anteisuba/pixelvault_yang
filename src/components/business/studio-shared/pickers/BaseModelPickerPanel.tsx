...
/**
 * ⚠ **画布已经不用它了**（S11b，2026-09-10）：四类节点卡与文本助手栏一律走方案 A
 * 的 `ModelPickerPopover`（`node-canvas-v2.md` §1.6）。这里还留着，是因为
 * **studio 域**（`StudioPromptArea` / `StudioMobileModelSheet` / `Studio3DWorkspace`）、
 * LLM 路由（`MainModelPicker` modality `llm_assist`）与配音间仍在用它。
