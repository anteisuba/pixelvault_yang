...
export function CanvasBottomDock({
  ...
  const rightInsetPx = assistantDockOpen
  ...
  return (
    <TooltipProvider delayDuration={250}>
      <div
        className="pointer-events-none absolute bottom-2 hidden md:block"
        style={{
          left: NODE_STUDIO_BOTTOM_DOCK.canvasInsetPx,
          right: rightInsetPx,
        }}
      >
        <div className="pointer-events-auto mx-auto flex w-fit items-center gap-1.5 rounded-2xl border border-node-panel-inner/70 bg-node-panel/95 px-1.5 py-1.5 shadow-node-panel backdrop-blur-xl">
