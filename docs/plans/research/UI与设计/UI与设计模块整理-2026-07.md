...
- **4 个再通用候选**：媒体结果卡（多套并存）· 生成中/失败/空态 · 参考图/附件条 · 发送/请求预览（视频完整、图/音频弱）。**不适合抽**：LoRA 整树、画布 NodeShell 系、VideoComposer 品牌条、HomeV3\*（营销皮肤禁止回灌 Studio）。
...
| **首页营销域**    | 方法来源锚（非皮肤来源）；GSAP 唯一合法落点 `HomeV3Motion.tsx`；营销皮肤与工程组件单向隔离                                              |
