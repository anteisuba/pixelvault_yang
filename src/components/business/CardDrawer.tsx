...
/**
 * CardDrawer — nav-level Sheet for browsing/managing all card types.
 *
 * Uses Tabs with 3 panels: Characters / Styles / Backgrounds.
 * Reuses existing card manager components via standalone hooks.
 *
 * @see 01-UI/UI-路線決策結論書.md D8 — Phase 2 末引入 CardDrawer
 */
...
export const CardDrawer = memo(function CardDrawer({
  ...
  // ─── Hooks (only active when drawer is open) ──────────────────
