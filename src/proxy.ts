...
export const config = {
  matcher: [
    '/((?!_next|robots\\.txt|sitemap\\.xml|(?:[^?]*/)?(?:opengraph-image|twitter-image)(?:/|$)|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|mp3|wav|ogg|m4a|opus|aac|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)',
    '/(api|trpc)(.*)',
  ],
}
