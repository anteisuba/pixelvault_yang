...
| seedance-25-capability.md | **Seedance 2.5 能力事实 + 画布/助手设计输入**：参数对照与代码对账 / 四模式映射 / 提示词公式 vs ScriptDoc（✅ 2026-08-03）        | 即梦官方手册 · `constants/video-model-send-plan.ts` · `types/script-doc.ts` |
