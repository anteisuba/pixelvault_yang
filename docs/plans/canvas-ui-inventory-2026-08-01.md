...
| 编号   | 组件         | 文件                                 | 职责                 | 状态清单                                                                                    | 真机             | 进度 |
| ------ | ------------ | ------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------- | ---------------- | ---- |
| **G1** | 助手把手     | `CanvasAssistantToggle.tsx`          | 收起时的入口         | 收起（竖排「助 手」两字）· hover                                                            | ✅               | ⬜   |
...
| **批 2 · 信息层级**（改结构不改配色） | E4 收起态白长条 · E1 顶栏四钮无主次 · C1 十四个等权动作 · D1/D2 参数条混装 · F1b 面板只填 1/3                                                                             | 「谁该重谁该轻」，靠布局 / 尺寸 / 留白解决                           |
...
| 2   | A7           | `running` 的媒体窗里有**进度条**，而图片族的 `ImageCardGeneratingOverlay` 注释明写生成态「无百分比、禁止假造」。**同一产品里两条相反做法并存**                                                                                                                                                                                |
...
| 16  | GEN2 · B2    | **蓝色选中环与红色失败边同时挂在同一张卡上** —— 两个环打架，读不出哪个是主状态                                                                                                                                                                                                                                                |
